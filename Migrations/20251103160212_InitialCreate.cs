        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FrontDeskId = table.Column<string>(type: "text", nullable: false),
                    FrontDeskUserId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Condos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Condos_AspNetUsers_FrontDeskUserId",
                        column: x => x.FrontDeskUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Condos_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentImageUrl = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Bookings_Condos_CondoId",
                        column: x => x.CondoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FrontDesks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FrontDesks_Condos_CondoId",
                        column: x => x.CondoId,
                        principalTable: "Condos",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Condos_FrontDeskUserId",
                table: "Condos",
                column: "FrontDeskUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Condos_OwnerId",
                table: "Condos",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_FrontDesks_CondoId",
                table: "FrontDesks",
                column: "CondoId");

            migrationBuilder.CreateIndex(
                name: "IX_FrontDesks_UserId",
                table: "FrontDesks",
                column: "UserId");
